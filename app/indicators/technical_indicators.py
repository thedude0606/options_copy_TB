...
class TechnicalIndicators:
    ...
    def stochastic(self, k_period=14, d_period=3, high_col='high', low_col='low', close_col='close'):
        """
        Calculate Stochastic Oscillator using instance data
        
        Args:
            k_period (int): Period for %K line
            d_period (int): Period for %D line (moving average of %K)
    ...
    def calculate_stochastic(self, data, k_period=14, d_period=3, high_col='high', low_col='low', close_col='close'):
        """
